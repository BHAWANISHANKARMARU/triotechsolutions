        ...
        <div className="relative isolate overflow-hidden bg-card border border-border shadow-card-shadow px-6 pt-16 sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Request a free consultation and get a customized training proposal tailored to your team's specific needs and goals.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              ...
              <Link href="#programs" className="text-base font-semibold leading-6 text-foreground">
