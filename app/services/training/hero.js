...
import trainingHero from "../../../assats/traning.svg";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground animate-fade-in-down">
              Corporate & Individual IT Training
            </h1>
            <p
              className="mt-6 max-w-xl mx-auto lg:mx-0 text-lg md:text-xl text-muted-foreground animate-fade-in-up"
              style={{ animationDelay: "0.3s" }}
            >
              Upskill your workforce and accelerate careers with our cutting-edge IT training programs, designed for today's technology landscape.
            </p>
          </div>
