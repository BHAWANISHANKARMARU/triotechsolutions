...
const Contact = () => {
  return (
    <section id="contact-campus" className="py-16 sm:py-24 bg-background/70">
      <div className="container mx-auto px-4">
        <div className="relative isolate overflow-hidden bg-card border border-border px-6 py-20 text-center shadow-card-shadow sm:rounded-3xl sm:px-16">
          <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Contact Our Campus Hiring Team
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
            Ready to build your future talent pipeline? Connect with our campus
            hiring experts to get started.
          </p>

          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-x-8 gap-y-4">
            <a
              href="mailto:campus@triotechsolutions.com"
              className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
            >
              <Mail className="h-5 w-5 text-primary" />
              <span>campus@triotechsolutions.com</span>
            </a>
