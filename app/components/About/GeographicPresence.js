...
const presence = [
  {
    ...
    description:
      "Serving key technology hubs across the nation. [Cities to be filled]",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Our network of recruiters and talent spans the entire country, from major metros to emerging tech cities.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "Nationwide Remote Hiring",
    description:
      "Access top IT talent from anywhere in the country with our specialized remote hiring solutions.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
const GeographicPresence = () => {
  return (
    <section id="presence" className="py-16 sm:py-24 bg-background/70">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Connecting Talent Across India
          </p>
        </div>
