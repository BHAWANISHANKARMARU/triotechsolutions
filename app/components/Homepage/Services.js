  ...
  const services = [
    {
      ...
      description:
        "Short-term IT project staffing. Quick deployment (24-48 hours). Ideal for urgent tech needs.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Full-time IT hiring solutions. Cultural fit assessment. Long-term talent acquisition.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
    ...
    },
    {
      title: "Outsourcing",
      description:
        "Complete team management. Reduced operational costs. Focus on core business.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2H19.95M12 12v-4m0 4h.01"
          />
        </svg>
      ),
    },
    {
      ...
      description:
        "Future-proof your workforce. Latest technology training. Custom learning paths.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
    ...
    },
    {
      ...
      description:
        "Business transformation projects. Cloud & infrastructure experts. Cybersecurity specialists.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
    ...
    },
    {
      title: "Campus Hiring",
      description:
        "Fresh IT talent acquisition. Graduate training programs. Build your tech pipeline.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
